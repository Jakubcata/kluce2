...
<html lang="en">
  ...
  <body>
    <nav class="navbar sticky-top navbar-expand-sm navbar-light jk-color-background mb-3">
      <a class="navbar-brand" href="https://www.jakubcata.eu">Egidio</a>
      ...
      <div class="collapse navbar-collapse order-3 order-sm-2" id="navbarNavDropdown">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link" target="_blank" href="https://docs.google.com/spreadsheets/d/108OdQupHyNuBoWgvUsOYjJjFYEvnfHBqodnFeoU8JEo/edit#gid=0">Stredeční služba</a>
          </li>
        </ul>
        <div class="ml-md-5">
